...
- **Functional supported**: One or more tests for this compset have been made using at least one resolution.  The resolutions/compsets have undergone some scientific validation and tuning, however, not to the extend of **Scientifically supported** compsets/resolutions. The user is encouraged to carefully examine the results.
...
+------------------------+-------------------------------------------+-------------------------------------+
| ne120_ne120_mg17       | Approximately 1/4 CAM-SE                  | F2000climo, F1850                   |
|                        |                                           |                                     |
+------------------------+-------------------------------------------+-------------------------------------+
