...
This is done by using one of the "F" compsets and details on using the scripts can be found in the :ref:`Building and Running CAM within CESM <building-and-running-cam>` section of this User's Guide or the `CESM2 Quick Start Guide <http://cesm-development.github.io/cime/doc/build/html/quickstart.html>`_. 
